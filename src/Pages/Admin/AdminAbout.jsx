...
const AdminAbout = () => {
  ...
  const submitHandler = async (values) => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/yoga/update-about`, formData, {
        headers: {
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/yoga/update-about`, {
        _id: abouts._id,
        para: abouts.para,
